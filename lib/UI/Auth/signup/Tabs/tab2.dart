            ...
            SizedBox(
              ...
              child: ElevatedButton(onPressed: () async {
                ...
                if(name.text != "" && email.text != "" && pass.text != "") {
                  res = await fcade.CreateUser(name.text, email.text, pass.text, "user");
              ...
              }, child: isvisible? Visibility(child: CircularProgressIndicator(color: Colors.white,),visible: isvisible,) : Text('SIGN UP AS USER'),
                style: ButtonStyle(
